...
batch_size=40  
train_dataset = FiducialPointCloudDataset(sampled_tensor, target_db, end_idx=10000)
val_dataset = FiducialPointCloudDataset(sampled_tensor, target_db, start_idx=12000, end_idx=13000)
